...
It uses the static site generator [Hugo](https://gohugo.io) with a port of the [Dimension theme](https://themes.gohugo.io/dimension/) from [HTML5 UP](https://html5up.net/).
